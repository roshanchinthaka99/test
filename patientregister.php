...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirmPassword) {
        echo "<script>alert('Passwords do not match!'); window.location.href='patientregister.php';</script>";
        exit();
    }
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Error: " . $stmt->error . "'); window.location.href='patientregister.php';</script>";
    }
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div class="signup-container">
            ...
            <a href="patientlogin.php" class="signup-link">Sign In</a>
        </div>
    </form>
</div>
