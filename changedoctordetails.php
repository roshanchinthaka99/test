...
if (isset($_GET['doctorID'])) {
    ...
    $sql = "SELECT * FROM doctordetails WHERE doctorID = ?";
...
<div class="container">
    ...
    <form action="updatedoctor.php" method="POST">
        ...
        <input type="text" name="doctorID" value="<?php echo $doctor['doctorID']; ?>">

        <label for="firstname">First Name:</label>
        <input type="text" id="firstname" name="firstname" value="<?php echo $doctor['firstname']; ?>" required>

        <label for="lastname">Last Name:</label>
        <input type="text" id="lastname" name="lastname" value="<?php echo $doctor['lastname']; ?>" required>
