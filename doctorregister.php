...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirmPassword) {
        echo "<script>alert('Passwords do not match!'); window.location.href='doctorregister.php';</script>";
        exit();
    }
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Registration successful!'); window.location.href='doctorlogin.php';</script>";
    } else {
        echo "<script>alert('Error: " . $stmt->error . "'); window.location.href='docotrregister.php';</script>";
    }
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div class="signup-container">
            ...
            <a href="doctorlogin.php" class="signup-link">Sign In</a>
        </div>
    </form>
</div>
